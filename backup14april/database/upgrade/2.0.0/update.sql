...
UPDATE `<<prefix>>settings` SET `key` = 'listings_review_activation' WHERE `key` = 'ads_review_activation';
...
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(1, 'en', 1, 'home', '{app.name} - Hello, World!', 'Welcome to {app.name} : 100% Job Board. Find a job near you. Simple, fast and efficient - {country.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(2, 'en', 2, 'register', 'Sign Up - {app.name}', 'Sign Up on {app.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(3, 'en', 3, 'login', 'Login - {app.name}', 'Log in to {app.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(4, 'en', 4, 'create', 'Post a Job', 'Post a Job - {country.name}.', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(5, 'en', 5, 'countries', 'Jobs in the World', 'Welcome to {app.name} : 100% Job Board. Find a job near you. Simple, fast and efficient.', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(6, 'en', 6, 'contact', 'Contact Us - {app.name}', 'Contact Us - {app.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(7, 'en', 7, 'sitemap', 'Sitemap {app.name} - {country.name}', 'Sitemap {app.name} - {country.name}. Job Bord.', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(8, 'fr', 1, 'home', '{app.name} - Hello, World!', 'Bienvenue sur {app.name} : Site d\'emplois 100% gratuit. Trouvez un travail près de chez vous. Simple, rapide et efficace - {country.name}', '{app.name}, {country.name}, offres d\'emploi, emplois, annonces, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(9, 'es', 1, 'home', '{app.name} - Hello, World!', 'Welcome to {app.name} : 100% Job Board. Find a job near you. Simple, fast and efficient - {country.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(10, 'fr', 2, 'register', 'S\'inscrire - {app.name}', 'S\'inscrire sur {app.name}', '{app.name}, {country.name}, offres d\'emploi, emplois, annonces, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(11, 'es', 2, 'register', 'Sign Up - {app.name}', 'Sign Up on {app.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(12, 'fr', 3, 'login', 'S\'identifier - {app.name}', 'S\'identifier sur {app.name}', '{app.name}, {country.name}, offres d\'emploi, emplois, annonces, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(13, 'es', 3, 'login', 'Login - {app.name}', 'Log in to {app.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(14, 'fr', 4, 'create', 'Publiez une offre d\'emploi', 'Publiez une offre d\'emploi - {country.name}.', '{app.name}, {country.name}, offres d\'emploi, emplois, annonces, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(15, 'es', 4, 'create', 'Publicar un anuncio gratuito', 'Publicar un anuncio gratuito - {country.name}.', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(16, 'fr', 5, 'countries', 'Emplois dans le monde', 'Bienvenue sur {app.name} : Site d\'emplois 100% gratuit. Trouvez un travail près de chez vous. Simple, rapide et efficace.', '{app.name}, {country.name}, offres d\'emploi, emplois, annonces, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(17, 'es', 5, 'countries', 'Jobs in the World', 'Welcome to {app.name} : 100% Job Board. Find a job near you. Simple, fast and efficient.', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(18, 'fr', 6, 'contact', 'Nous contacter - {app.name}', 'Nous contacter - {app.name}', '{app.name}, {country.name}, offres d\'emploi, emplois, annonces, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(19, 'es', 6, 'contact', 'Contact Us - {app.name}', 'Contact Us - {app.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(20, 'fr', 7, 'sitemap', 'Plan du site {app.name} - {country.name}', 'Plan du site {app.name} - {country.name}. Site d\'emplois.', '{app.name}, {country.name}, offres d\'emploi, emplois, annonces, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(21, 'es', 7, 'sitemap', 'Sitemap {app.name} - {country.name}', 'Sitemap {app.name} - {country.name}. Job Bord.', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(22, 'en', 22, 'password', 'Lost your password? - {app.name}', 'Lost your password? - {app.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(23, 'fr', 22, 'password', 'Mot de passe oublié? - {app.name}', 'Mot de passe oublié? - {app.name}', '{app.name}, {country.name}, offres d\'emploi, emplois, annonces, script, app, premium jobs', 1);
INSERT INTO `<<prefix>>meta_tags` (`id`, `translation_lang`, `translation_of`, `page`, `title`, `description`, `keywords`, `active`) VALUES(24, 'es', 22, 'password', '¿Perdiste tu contraseña? - {app.name}', '¿Perdiste tu contraseña? - {app.name}', '{app.name}, {country.name}, jobs ads, jobs, ads, script, app, premium jobs', 1);
