								...
								<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo"
									...
									<tr>
										...
										<td style="width:14%" class="add-img-td">
											<a class="btn btn-default" href="{{ privateFileUrl($resume->filename) }}" target="_blank">
										...
										<td style="width:10%" class="action-td">
											<div>
												@if ($resume->user_id==$user->id)
													...
													<p>
														<a class="btn btn-danger btn-sm confirm-simple-action" href="{{ url('account/resumes/'.$resume->id.'/delete') }}">
															<i class="fa fa-trash"></i> {{ t('Delete') }}
														</a>
													</p>
												@endif
